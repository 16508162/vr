...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		me._image_131.ggDeactivate=function () {
			me._image_131.style[domTransition]='none';
			me._image_131.style.visibility='hidden';
			me._image_131.ggVisible=false;
		}
		...
		me._image_131.ggNodeChange=function () {
			if (me._image_131.ggLastIsActive!=me._image_131.ggIsActive()) {
				me._image_131.ggLastIsActive=me._image_131.ggIsActive();
				if (me._image_131.ggIsActive()) {
					if (me._image_131.ggActivate) me._image_131.ggActivate();
				} else {
					if (me._image_131.ggDeactivate) me._image_131.ggDeactivate();
				}
			}
		}
		me._marker_10.appendChild(me._image_131);
		...
		me._marker_1.appendChild(me._image_130);
		...
		hs='data:image/png;base64,'+
			''+
			''+
			''+
			''+
			''+
			''+
			'';
		els.setAttribute('src',hs);
		els.ggNormalSrc=hs;
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;');
		...
		el=me._image_3_novr=document.createElement('div');
		els=me._image_3_novr__img=document.createElement('img');
		els.className='ggskin ggskin_image_3_novr';
		hs='data:image/png;base64,'+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			'';
		els.setAttribute('src',hs);
		els.ggNormalSrc=hs;
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;');
		els.className='ggskin ggskin_image';
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._image_3_novr.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._image_3_novr.onclick=function (e) {
			player.openUrl("withoutvr01.html","_self");
			me._image_3_novr.style[domTransition]='none';
			me._image_3_novr.style.visibility='hidden';
			me._image_3_novr.ggVisible=false;
			me._image_3_vr.style[domTransition]='none';
			me._image_3_vr.style.visibility=(Number(me._image_3_vr.style.opacity)>0||!me._image_3_vr.style.opacity)?'inherit':'hidden';
			me._image_3_vr.ggVisible=true;
		}
		me._image_3_novr.ggUpdatePosition=function (useTransition) {
		}
		me._container_base.appendChild(me._image_3_novr);
		...
		me._image_13.onmouseover=function (e) {
			me._image_13.style[domTransition]='none';
			me._image_13.ggParameter.sx=1.1;me._image_13.ggParameter.sy=1.1;
			me._image_13.style[domTransform]=parameterToTransform(me._image_13.ggParameter);
		}
		me._image_13.onmouseout=function (e) {
			me._image_13.style[domTransition]='none';
		...
		me._container_base.appendChild(me._image_13);
		...
		me._image_3_vr.onclick=function (e) {
			...
			me._image_3_novr.style[domTransition]='none';
			me._image_3_novr.style.visibility=(Number(me._image_3_novr.style.opacity)>0||!me._image_3_novr.style.opacity)?'inherit':'hidden';
			me._image_3_novr.ggVisible=true;
		}
	...
	me.skinTimerEvent=function() {
		...
		var hs='';
		if (me._image_131.ggParameter) {
			hs+=parameterToTransform(me._image_131.ggParameter) + ' ';
		}
		hs+='rotate(' + (-1.0*(1 * player.getPanNorth() + 0)) + 'deg) ';
		hs+='scale(' + (Math.tan(player.getFov()/2.0*Math.PI/180.0)*1 + 0) + ',1.0) ';
		me._image_131.style[domTransform]=hs;
		var hs='';
	...
	function SkinHotspotClass_ht_pic(parentScope,hotspot) {
		...
		me._ht_pic.onclick=function (e) {
			...
			skin._button_1.style[domTransition]='none';
			skin._button_1.style.visibility=(Number(skin._button_1.style.opacity)>0||!skin._button_1.style.opacity)?'inherit':'hidden';
			skin._button_1.ggVisible=true;
			skin.hotspotProxyClick(me.hotspot.id, me.hotspot.url);
		}
